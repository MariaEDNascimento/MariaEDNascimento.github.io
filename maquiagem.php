        ...
        <div class="filtros-container">
            ...
            <div class="filtro-grupo">
                ...
                <div class="filtro-opcoes">
                    <div class="filtro-opcao ativo">Blush</div>
                    <div class="filtro-opcao">Mascara</div>
                    <div class="filtro-opcao">Sombras</div>
                    <div class="filtro-opcao">Batons</div>
                    <div class="filtro-opcao">Seruns</div>
                </div>
            </div>
        </div>
